...
interface CallVideoIncomingIconProps {
  size?: number;
  color?: string;
}

/** Conversation/call state icon from Figma (Frame-11). */
export const CallVideoIncomingIcon: React.FC<CallVideoIncomingIconProps> = ({
  size = 20,
  color = '#7742F0',
}) => (
  <Svg width={size} height={size} viewBox="0 0 20 20" fill="none">
    ...
    />
    <Path
      d="M6.88795 8.05466C6.88795 8.05466 9.41097 7.85731 9.76628 8.21259C10.1216 8.56788 9.92417 11.0909 9.92417 11.0909M9.61522 8.36364L5.59375 12.5562"
      stroke={color}
      strokeWidth={1.2}
      strokeLinecap="round"
