...
interface CallVideoOutgoingIconProps {
  size?: number;
  color?: string;
}

/** Conversation/call state icon from Figma (Frame-9). */
export const CallVideoOutgoingIcon: React.FC<CallVideoOutgoingIconProps> = ({
  size = 20,
  color = '#7742F0',
}) => (
