...
/** Figma AIRA — voice call header control (node 3597-8637). */
interface ChatHeaderVoiceCallIconProps {
  size?: number;
  color?: string;
}

export const ChatHeaderVoiceCallIcon: React.FC<ChatHeaderVoiceCallIconProps> = ({
  size = 24,
  color = '#1A1A1A',
}) => (
