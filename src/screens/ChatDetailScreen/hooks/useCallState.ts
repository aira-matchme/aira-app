...
export interface UseCallStateParams {
  ...
  handledIncomingCallRef: MutableRefObject<string | null>;
}
...
export function useCallState({
  ...
  const cancelSwitchToVideoRequest = useCallback(() => setSwitchToVideoPopupVisible(false), []);
