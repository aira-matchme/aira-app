...
export const CallOverlay = React.memo(function CallOverlay(props: CallOverlayProps) {
  const {
    ...
    dismissIncomingVideoCallModal, requestSwitchVoiceToVideo, openSwitchToVideoPopup,
              ...
              <View style={styles.callStateRingingActionsRow}>
                <View style={styles.callStateRingingActionsCapsule}>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={!isOutgoingVoiceRinging && !isSwitchingVoiceToVideo ? openSwitchToVideoPopup : undefined}
