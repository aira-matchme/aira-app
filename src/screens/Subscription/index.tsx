...
const PlusGemIcon: React.FC = () => (
  <Svg width={26} height={26} viewBox="0 0 26 26" fill="none">
    <Defs>
      <SvgLinearGradient id="pgGrad" x1="13" y1="0" x2="13" y2="26" gradientUnits="userSpaceOnUse">
...
export const SubscriptionScreen: React.FC = () => {
  ...
  const monthlyProduct =
    subscriptions.find((s) => s.id.toLowerCase().includes('month')) ??
    subscriptions[0];
