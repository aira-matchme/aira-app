...
const PHOTO_PLACEHOLDER = require('../../../assets/images/profilescreen.png');
...
type RouteProps = RouteProp<AuthStackParamList, 'OnboardingPhotoQuestion'>;

export const OnboardingPhotoQuestionScreen: React.FC = () => {
