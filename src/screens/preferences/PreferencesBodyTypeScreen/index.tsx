          ...
          >
            ...
            <View style={styles.howItWorks}>
              <Text style={styles.howItWorksText}>
                Select and rank all 5 body types in the order you find the most appealing. You need to select all 5 to continue.
              </Text>
            </View>
                ...
                return (
                  ...
                  >
                    ...
                    <View style={[styles.checkbox, isSelected && styles.checkboxSelected]}>
                      {isSelected && <Text style={styles.checkboxRankText}>{rank}</Text>}
                    </View>
                  </Pressable>
                );
              })}
